...
<body>
	<div id="locale">
		<a class="localeItem" href="/Room8Try1/pages/eng/user/bookARoom.jsp"><img
			...
			title="English" /> </a>| <a class="localeItem"
			href="/Room8Try1/pages/fra/user/bookARoom.jsp"> <img
			src="/Room8Try1/images/french.png" height="20px"
			alt="Fran&ccedil;ais" title="Fran&ccedil;ais" />
		</a>| <a class="LocaleItem" href="/Room8Try1/pages/esp/user/bookARoom.jsp">
			<img src="/Room8Try1/images/mexican.png" height="20px"
			alt="Espa&ntilde;ol" title="Espa&ntilde;ol" />
		</a>| <a class="LocaleItem" href="/Room8Try1/pages/afr/user/bookARoom.jsp">
	...
	<div id="header">
		...
		<table ID="menutable" align="center">
			<tr>
				<td><a class="menuItem"
					href="/Room8Try1/pages/eng/user/home.jsp">Schedule</a></td>
				<td><a class="menuItem"
